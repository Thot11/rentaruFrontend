          ...
          <div className="pancarteContainer">
            ...
            <div className="quote">
              ...
              <p className="quoteText">
                Je suis vraiment satisfaite, j'ai pu agrandir ma collection de manga en mettant à louer ma collection de Shojo.
              </p>

            </div>
            <div className="customerInfo">
              <img className="userPicture" src="/userPicture.png" alt="userPicture"/>
              <p className="userName">Jacqueline Jacques</p>
            </div>
          </div>
