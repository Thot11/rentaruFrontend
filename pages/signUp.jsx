  ...
  return (
    <div>
      ...
      <div className="signInContainer">
        mail
        <input type="email" defaultValue={mail} onChange={(e) => setMail(e.target.value)} />
        username
        <input type="text" defaultValue={username} onChange={(e) => setUsername(e.target.value)} />
        prenom
        <input type="text" defaultValue={prenom} onChange={(e) => setPrenom(e.target.value)} />
        nom
        ...
        ville
        <input type="text" defaultValue={ville} onChange={(e) => setVille(e.target.value)} />
        departement
        <input type="number" defaultValue={departement} onChange={(e) => setDepartement(e.target.value)} />
        telephone
