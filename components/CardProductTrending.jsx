...
const CardProductTrending = ({ product, key, user }) => {
  ...
  useEffect(() => {
    if (typeof ownerUser === "number") {
      getUser(ownerUser).then((resp) => setOwnerUser(resp))
    }
  }, [ownerUser])
                  ...
                  <div>
                    ...
                    <div className="stars">
                      ...
                      [1,2,3,4,5].map((el, index) => {
                        return (
                          <svg width="6" height="5" viewBox="0 0 6 5" fill="none" xmlns="http://www.w3.org/2000/svg" key={index} className={index < ownerUser.note ? 'starFill' : 'starEmpty'}>
